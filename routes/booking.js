...
router.get("/flight/:flightId", verify, verifyAdmin, bookingController.getBookingsByFlightId);

router.get("/user/:userId", verify, verifyAdmin, bookingController.getBookingsByUserId);
